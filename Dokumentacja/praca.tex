...
\usepackage{pgfplots}
\pgfplotsset{compat=1.18} % Ustawienie wersji dla kompatybilności
...
\author{Piotr Pająk, Mateusz Czapor}
\shortauthor{Piotr P., Mateusz C.}
\noAlbum{131483, 131416}

\titlePL{Projekt Zaliczeniowy: System biometryczny oparty na rozpoznawaniu twarzy i analizie emocji}
\titleEN{Biometric System Based on Face Recognition and Emotion Analysis}

\shorttitlePL{Projekt z Biometrycznych Systemów Zabezpieczeń}
\shorttitleEN{Project in Biometric Security Systems}

\thesistype{Projekt zaliczeniowy}

\thesisDone{Prowadzący}
\supervisor{dr Zbigniew Gomółka}
%\supervisor{Zbigniew Gomółka PhD}
...
% \appendix
% --- Oświadczenia o samodzielności ---
\makeatletter % Dostęp do komend z @

% Oświadczenie dla pierwszego autora
{\def\@author{Piotr Pająk}\def\@noAlbum{131483}\input{appendix/statement-A.tex}}

\clearpage

% Oświadczenie dla drugiego autora
{\def\@author{Mateusz Czapor}\def\@noAlbum{131416}\input{appendix/statement-A.tex}}
